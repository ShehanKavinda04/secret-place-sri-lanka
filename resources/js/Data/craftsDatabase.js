export const categoryDatabase = {
    ...
    'handloom-textiles': {
        ...
        products: [
            { id: 501, filterId: 'clothing', title: "Handloom Saree", subtitle: "Beautifully woven cotton saree.", price: "Rs. 6,000.00", rating: "4.7", reviewsCount: 312, description: "A beautifully woven cotton handloom saree with vibrant traditional colors.", features: ["100% Cotton", "Handwoven", "Vibrant colors"], image: "/images/crafts/handloom_saree.jpg", subImages: ["/images/crafts/handloom_saree.jpg"] },
            { id: 502, filterId: 'homedecor', title: "Woven Table Runner", subtitle: "Colorful handloom table runner.", price: "Rs. 2,500.00", rating: "4.6", reviewsCount: 89, description: "A colorful handloom table runner to brighten up your dining area.", features: ["Handloom", "Durable cotton", "Washable"], image: "/images/crafts/woven_table_runner.jpg", subImages: ["/images/crafts/woven_table_runner.jpg"] },
            { id: 503, filterId: 'clothing', title: "Handloom Sarong", subtitle: "Comfortable and breathable cotton sarong.", price: "Rs. 3,500.00", rating: "4.8", reviewsCount: 156, description: "Traditional Sri Lankan handloom sarong made from soft, breathable cotton.", features: ["100% Cotton", "Traditional wear", "Breathable"], image: "/images/crafts/handloom_sarong.jpg", subImages: ["/images/crafts/handloom_sarong.jpg"] },
            { id: 504, filterId: 'homedecor', title: "Woven Cushion Cover", subtitle: "Brighten up your living room with traditional patterns.", price: "Rs. 1,800.00", rating: "4.9", reviewsCount: 75, description: "Add a splash of color to your home with these intricately woven cushion covers.", features: ["Vibrant patterns", "Durable", "Square fit"], image: "/images/crafts/woven_cushion_cover.jpg", subImages: ["/images/crafts/woven_cushion_cover.jpg"] },
            { id: 505, filterId: 'clothing', title: "Cotton Handloom Scarf", subtitle: "Lightweight scarf perfect for tropical weather.", price: "Rs. 2,200.00", rating: "4.7", reviewsCount: 110, description: "A versatile, lightweight handloom scarf that pairs well with any outfit.", features: ["Lightweight", "Versatile", "Soft cotton"], image: "/images/crafts/cotton_handloom_scarf.jpg", subImages: ["/images/crafts/cotton_handloom_scarf.jpg"] }
        ]
    },
    'craft-village-tour': {
