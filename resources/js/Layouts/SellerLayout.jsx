...
export default function SellerLayout({ header, children }) {
    ...
    const navigation = [
        ...
        },
        {
            ...
            href: route("seller.businesses"),
            routeName: "seller.businesses",
            icon: Home,
        },
        {
            name: "Reservations",
            href: route("seller.bookings"),
            routeName: "seller.bookings",
            icon: Calendar,
        },
        {
            name: "Financials",
                ...
                <div className="flex flex-col h-full">
                    ...
                    <div className="p-4 mt-auto">
                        <Link
                            ...
                            className="flex items-center gap-3 px-4 py-3 rounded-xl text-emerald-100/80 hover:bg-[#143d31] hover:text-white transition-colors"
                        >
            ...
            <div className="flex-1 flex flex-col min-w-0">
                <header className="h-20 bg-white border-b border-gray-200 shadow-sm flex items-center justify-between px-4 sm:px-6 lg:px-8 z-30 sticky top-0">
                    <div className="flex items-center gap-4">
                        ...
                        <h1 className="text-2xl font-bold text-gray-900 font-sansDisplay hidden sm:block">
                            {header}
                        </h1>
                    </div>
                ...
                <main className="flex-1 overflow-y-auto">
                    <div className="p-4 sm:p-6 lg:p-8">
                        <div className="sm:hidden mb-6">
                            <h1 className="text-2xl font-bold text-gray-900 font-sansDisplay">
                                {header}
                            </h1>
                        </div>
                        {children}
