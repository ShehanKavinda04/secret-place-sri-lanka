...
export default function CustomerLayout({ header, children }) {
    ...
    return (
        <div className="min-h-screen bg-[#F8FAFC] font-sans flex flex-col md:flex-row">
            ...
            <aside
                className={`fixed inset-y-0 left-0 z-50 w-72 bg-[#1B4D3E] text-white shadow-xl transform transition-transform duration-300 md:relative md:translate-x-0 ${sidebarOpen ? "translate-x-0" : "-translate-x-full"}`}
            >
