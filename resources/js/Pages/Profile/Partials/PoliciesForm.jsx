    ...
    return (
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 md:p-8 mb-8 relative">
            <h3 className="text-lg font-bold text-slate-900 mb-6 border-b border-slate-100 pb-4 flex items-center">
                <Clock className="w-5 h-5 mr-2 text-slate-500" /> Policies &
                Preferences
            </h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full rounded-lg border-slate-300 bg-white text-slate-900 placeholder:text-slate-400 focus:border-[#1B4D3E] focus:ring-[#1B4D3E] shadow-sm text-sm"
                            />
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-slate-700 mb-1">
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option value="Strict">
                                    Strict (50% refund up to 1 week prior)
                                </option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4 bg-slate-50 p-4 rounded-xl border border-slate-100">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-xs text-slate-600">
                                    Receive instant messages for new bookings
                                    and cancellations.
                                </p>
                            </div>
                            <button
                                ...
                                className={`${
                                    formData.notifications.whatsapp_alerts
                                        ? "bg-emerald-500"
                                        : "bg-slate-200"
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-xs text-slate-600">
                                    Receive monthly payout reports and invoice
                                    copies.
                                </p>
                            </div>
                            <button
                                ...
                                className={`${
                                    formData.notifications.email_invoices
                                        ? "bg-emerald-500"
                                        : "bg-slate-200"
                                } relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none`}
                            >
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-xs text-slate-600">
                                    For e-commerce: receive alerts when guests
                                    request shipping updates.
                                </p>
                            </div>
                            <button
                                type="button"
                                ...
                                className={`${
                                    formData.notifications.sms_alerts
                                        ? "bg-emerald-500"
                                        : "bg-slate-200"
                                } relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none`}
                            >
