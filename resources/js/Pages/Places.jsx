...
const eightSacredPlaces = [
    {
        ...
        reviews: "320",
        description:
            "One of the world's oldest historically documented trees, radiating immense spiritual peace and sacred Buddhist heritage.",
    ...
    },
    {
        ...
        reviews: "415",
        description:
            "A magnificent, awe-inspiring ancient stupa housing sacred relics, standing as a grand marvel of engineering and devotion.",
    ...
    },
    {
        ...
        reviews: "210",
        description:
            "The oldest dagoba in Sri Lanka, constructed to enshrine the sacred collarbone relic of the Buddha.",
    ...
    },
    {
        ...
        reviews: "275",
        description:
            "A massive monastic complex and ancient center of Buddhist scholarship, featuring a towering, majestic brick stupa.",
    ...
    },
    {
        ...
        reviews: "310",
        description:
            "Once the tallest stupa in the ancient world, representing an unparalleled masterpiece of ancient Sri Lankan architecture.",
    ...
    },
    {
        ...
        reviews: "185",
        description:
            "Built by King Dutugemunu after leaving his scepter containing Buddha relics, a symbol of profound devotion.",
    ...
    },
    {
        ...
        reviews: "140",
        description:
            "An ancient stupa built by King Vattagamani Abhaya, surrounded by beautiful monolithic stone pillars and ruins.",
    ...
    },
    {
        ...
        reviews: "220",
        description:
            "The Brazen Palace, an ancient multistoried building with hundreds of stone pillars, once a grand monastery.",
...
const otherSites = [
    {
        ...
        reviews: "350",
        description:
            "A beautiful rock temple famous for its exquisite ancient stone carvings, including the renowned Isurumuniya Lovers.",
    ...
    },
    {
        ...
        reviews: "110",
        description:
            "An ancient forest monastery complex where pious monks meditated amidst scenic, rugged rock caves and serene surroundings.",
    ...
    },
    {
        ...
        reviews: "280",
        description:
            "A serene temple complex surrounding the sacred Bodhi tree, offering a profoundly peaceful environment for reflection.",
    ...
    },
    {
        ...
        reviews: "490",
        description:
            "The sacred mountain peak where Buddhism was introduced to Sri Lanka, featuring ancient steps and panoramic views.",
    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-[#FAF9F6] text-[#2c1d11] font-sans selection:bg-royalGold-500 selection:text-royalMaroon-950 flex flex-col">
                ...
                >
                    <img
                        src="/images/sacred_sites.png"
                        alt="Sacred Sites & Shrines"
                        className="w-full h-full object-cover"
                    />
                    <div className="absolute inset-0 bg-gradient-to-b from-slate-950/70 via-slate-950/50 to-[#FAF9F6]" />
                    <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
                        <span className="text-xs uppercase tracking-widest font-bold text-royalGold-400 mb-2">
                        ...
                        <p className="mt-3 text-white/70 text-sm max-w-xl font-light">
                            Explore the ancient, sacred heart of Anuradhapura,
                            home to venerable stupas, historic monasteries, and
                            deeply revered Buddhist heritage sites.
                        </p>
                    </div>
                </motion.div>
                ...
                >
                    ...
                    <div className="space-y-3 text-left border-b border-royalGold-400/20 pb-8">
                        <span className="text-xs uppercase tracking-widest font-bold text-royalGold-700">
                            Exploration Desk
                        </span>
