...
export default function Translator({ auth, initialTab = "translator" }) {
    ...
    useEffect(() => {
        try {
            const savedHistory = localStorage.getItem(
                "secretplaces_translation_history",
            );
            if (savedHistory) {
    ...
    const samplePhrases = [
        ...
        {
            label: "ශ්‍රී ලංකාවට සාදරයෙන් පිළිගනිමු",
            text: "ශ්‍රී ලංකාවට සාදරයෙන් පිළිගනිමු",
            desc: "Welcome to Sri Lanka",
        },
        { label: "කැවුම්", text: "කැවුම්", desc: "Cultural Sweetmeat" },
        {
            label: "දළදා පෙරහැර",
            text: "දළදා පෙරහැර",
            desc: "Sacred Tooth Procession",
        },
        {
            label: "මම ශ්‍රී ලංකාවට ආදරෙයි",
            text: "මම ශ්‍රී ලංකාවට ආදරෙයි",
            desc: "I love Sri Lanka",
        },
    ];
    ...
    const handlePredictDemand = async () => {
        ...
        try {
            ...
            if (response.data && response.data.predicted_demand !== undefined) {
                ...
                let densityColor =
                    "text-[#e6c875] border-[#e6c875]/40 bg-[#e6c875]/10";
                let advice =
                    "Expect typical visitor traffic. Recommended visiting time: 7:00 AM - 10:00 AM or 4:30 PM.";
                ...
                if (count > 600) {
                    ...
                    advice =
                        "High visitor influx predicted. Expect longer queues at sacred stupas. Early morning visits recommended.";
                } else if (count < 300) {
                    densityLevel = "Light Crowd / Peaceful";
                    densityColor =
                        "text-emerald-300 border-emerald-500/40 bg-emerald-500/15";
                    advice =
                        "Serene and quiet environment. Ideal for quiet meditation and photography.";
                }
                ...
                setForecastError(
                    "Unexpected response from AI forecast engine.",
                );
            }
        } catch (err) {
            ...
            setForecastError(
                err.response?.data?.message ||
                    "Failed to generate CwGBM crowd prediction.",
            );
        } finally {
            ...
            <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10">
                ...
                >
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-amber-300 text-xs font-semibold tracking-wider uppercase backdrop-blur-md">
                        ...
                        Unified AI Engine (`model.safetensors` &
                        `cwgbm_model.pkl`)
                    </div>
                    ...
                    <p className="max-w-2xl mx-auto text-sm sm:text-base text-emerald-100/80 leading-relaxed font-sansDisplay">
                        Explore authentic Sri Lankan heritage with neural
                        language translation (`model.safetensors`) and
                        predictive tourist crowd forecasting
                        (`cwgbm_model.pkl`).
                    </p>
                            ...
                            <div className="lg:col-span-6 space-y-4">
                                ...
                                <div className="relative">
                                    <textarea
                                        ...
                                        placeholder={
                                            srcLang === "sin_Sinh"
                                                ? "මෙහි සිංහල වාක්‍යයක් හෝ වචනයක් ටයිප් කරන්න (e.g. ඔබට කෙසේද? හෝ දළදා පෙරහැර)..."
                                                : "Type English phrase here..."
                                        }
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {samplePhrases.map((chip, idx) => (
                                            ...
                                            >
                                                ...
                                                <span className="text-[10px] text-emerald-200/50 group-hover:text-amber-200">
                                                    ({chip.desc})
                                                </span>
                                            </button>
                                        ))}
                                ...
                                >
                                    {isLoading ? (
                                        <span>
                                            Processing with model.safetensors...
                                        </span>
                                    ) : (
                                ...
                                <div>
                                    <div className="flex items-center justify-between pb-3">
                                        ...
                                        {sourceEngine && (
                                            ...
                                            >
                                                {sourceEngine === "glossary"
                                                    ? "Cultural Glossary Match"
                                                    : "Neural AI Model (`model.safetensors`)"}
                                            </span>
                                        )}
                                    </div>
                                    ...
                                    <div className="bg-[#051613] border border-emerald-500/30 rounded-2xl p-5 min-h-[170px] relative flex flex-col justify-between">
                                        {translatedText ? (
                                                ...
                                                <div className="flex items-center justify-between pt-4 mt-4 border-t border-emerald-500/20">
                                                    <div className="flex items-center gap-3">
                                                        <button
                                                            ...
                                                            className="p-2 rounded-xl bg-emerald-500/15 hover:bg-emerald-500/25 text-amber-300 text-xs font-semibold flex items-center gap-1"
                                                        >
                                                            Listen
                                                        </button>
                                                        <button
                                            ...
                                            <div className="flex flex-col items-center justify-center h-36 text-center space-y-2 text-emerald-200/40">
                                                <p className="text-sm font-sansDisplay">
                                                    Translation output will
                                                    appear here.
                                                </p>
                                            </div>
                                        )}
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                {history.length > 0 && (
                                    <button
                                        ...
                                        className="text-xs text-emerald-200/60 hover:text-amber-300"
                                    >
                                        Clear History
                                    </button>
                                )}
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                    {history.map((item) => (
                                        <div
                                            ...
                                            className="p-3.5 rounded-xl bg-[#051613] hover:bg-[#08201b] border border-emerald-500/20 cursor-pointer space-y-1"
                                        >
                    ...
                    >
                        ...
                        <div className="lg:col-span-6 bg-[#0c2a25]/90 border border-emerald-500/30 rounded-3xl p-6 sm:p-8 space-y-6 shadow-2xl backdrop-blur-xl">
                            <div className="flex items-center justify-between pb-2 border-b border-emerald-500/20">
                                <div>
                                    <h2 className="font-display font-bold text-xl text-amber-300">
                                        CwGBM Forecast Parameters
                                    </h2>
                                    <p className="text-xs text-emerald-200/70">
                                        CatBoost Gradient Boosting AI Model
                                        (`cwgbm_model.pkl`)
                                    </p>
                                </div>
                            ...
                            <div className="space-y-4 pt-2">
                                ...
                                <div>
                                    <div className="flex justify-between text-xs font-bold text-amber-300 mb-1">
                                        <span>
                                            Historical Base Demand (Visitors)
                                        </span>
                                    ...
                                    <input
                                        ...
                                        value={laggedDemand}
                                        onChange={(e) =>
                                            setLaggedDemand(e.target.value)
                                        }
                                        className="w-full accent-amber-400 bg-[#051613] rounded-lg h-2"
                                    />
                                </div>
                            ...
                            >
                                {isPredicting ? (
                                    <span>
                                        Computing Gradient Boosting AI
                                        Prediction...
                                    </span>
                                ) : (
                                    <span>Compute CwGBM AI Forecast</span>
                                )}
                            </button>
                                    ...
                                    {predictionResult ? (
                                        <div className="space-y-6 pt-4">
                                            ...
                                            <div className="flex items-baseline gap-3">
                                                ...
                                                <span className="text-base text-emerald-200/80 font-medium">
                                                    Estimated Visitors / Day
                                                </span>
                                            </div>
                                            ...
                                            <div className="flex items-center gap-2">
                                                <span
                                                    className={`px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider border ${predictionResult.densityColor}`}
                                                >
                                                    {
                                            ...
                                            <div className="pt-2">
                                                <button
                                                    onClick={
                                                        handleTranslateAdviceToSinhala
                                                    }
                                                    disabled={
                                                        isTranslatingAdvice
                                                    }
                                        ...
                                        <div className="flex flex-col items-center justify-center h-64 text-center space-y-3 text-emerald-200/40">
                                            ...
                                            <p className="text-sm font-sansDisplay">
                                                Adjust sliders and click
                                                'Compute CwGBM AI Forecast' to
