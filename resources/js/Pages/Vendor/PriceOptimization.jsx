...
export default function PriceOptimization({ auth }) {
            ...
            try {
                ...
                if (response.data.status === 'success') {
                    setResults({
                        ...
                        revenue: response.data.expected_profit // Mapping profit from AI to 'revenue' for the UI context
                    });
                } else {
    ...
    return (
        <AuthenticatedLayout
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Revenue & Pricing / AI Price Optimization</h2>}
        >
            <Head title="AI Price Optimization" />
            
            <div className="min-h-screen bg-slate-50 text-slate-900 font-sans flex flex-col py-8">
                <main className="max-w-[1200px] mx-auto w-full px-4 sm:px-6 lg:px-8">
