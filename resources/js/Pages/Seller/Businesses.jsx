...
export default function PropertyListings() {
    ...
    const stats = {
        ...
        inactive: properties.filter(
            (p) => p.status === "draft" || p.status === "inactive",
        ).length,
    };
    ...
    useEffect(() => {
        ...
        const unsubscribe = propertyService.subscribeToPropertyChanges(
            (newProperties) => {
                ...
                <div className="md:flex md:items-center md:justify-between mb-6">
                    <div className="flex-1 min-w-0">
                        ...
                        <p className="mt-1 text-sm text-slate-500">
                            Add new eco-stays, update pricing, and manage
                            availability.
                        </p>
                    </div>
                    ...
                    {isLoading ? (
                        ...
                        <div className="text-center py-20 bg-white rounded-lg shadow-sm border border-slate-200">
                            ...
                            <div className="mt-6">
                                <button
                                    onClick={() => setIsModalOpen(true)}
                                    className="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-[#1B4D3E] hover:bg-[#133c30]"
                                >
                                        ...
                                        <div className="mt-4 flex items-center justify-between border-t border-slate-100 pt-4">
                                            <div>
                                                ...
                                                <p className="text-lg font-bold text-[#D97706]">
                                                    {currency === "LKR"
                                                        ? `Rs. ${property.base_price_lkr.toLocaleString()}`
                                                        : `$${property.base_price_usd}`}{" "}
                                            ...
                                            <div className="flex flex-col items-end">
                                                ...
                                                <label className="flex items-center cursor-pointer mt-2">
                                                    <div className="relative">
                                                        ...
                                                        />
                                                        <div
                                                            className={`block w-10 h-6 rounded-full transition-colors ${property.status === "active" ? "bg-[#1B4D3E]" : "bg-slate-300"}`}
                                                        ></div>
                                                        <div
                                                            className={`dot absolute left-1 top-1 bg-white w-4 h-4 rounded-full transition-transform ${property.status === "active" ? "transform translate-x-4" : ""}`}
                                                        ></div>
                                                    </div>
                                                </label>
                                            </div>
                                    ...
                                    {properties.map((property) => (
                                        ...
                                        >
                                                ...
                                                <div className="flex items-center space-x-3">
                                                    ...
                                                    <label className="flex items-center cursor-pointer">
                                                        <div className="relative">
                                                            ...
                                                            />
                                                            <div
                                                                className={`block w-8 h-5 rounded-full transition-colors ${property.status === "active" ? "bg-[#1B4D3E]" : "bg-slate-300"}`}
                                                            ></div>
                                                            <div
                                                                className={`dot absolute left-1 top-1 bg-white w-3 h-3 rounded-full transition-transform ${property.status === "active" ? "transform translate-x-3" : ""}`}
                                                            ></div>
                                                        </div>
                                                    </label>
                                                </div>
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <button className="text-[#1B4D3E] hover:text-[#133c30] mr-4">
