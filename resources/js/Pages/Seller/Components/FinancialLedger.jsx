    ...
    const expenses = [
        {
            ...
            category: "Cleaning",
            amount: 12000,
            note: "Deep clean for eco cabins",
        },
        {
            id: 2,
            date: "Oct 25",
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-2">
                <div>
                    ...
                    <p className="text-sm text-gray-500">
                        Track revenue, platform commissions, and payout
                        schedules.
                    </p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                <div className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 flex flex-col justify-between">
                    <div>
                        ...
                        <p className="text-xs text-gray-400 mt-1">
                            Applied only to Platform Referrals
                        </p>
                    </div>
                </div>
                ...
                <div className="bg-[#1B4D3E] p-5 rounded-2xl shadow-sm text-white flex flex-col justify-between relative overflow-hidden">
                    ...
                    <div className="flex items-center justify-between mt-4">
                        ...
                        <button className="px-3 py-1 bg-white text-[#1B4D3E] text-xs font-bold rounded-lg hover:bg-emerald-50">
                            Request Payout
                        </button>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col">
                    <div className="flex justify-between items-center mb-6">
                        <h3 className="text-lg font-bold text-gray-900 font-sansDisplay">
                            Expense Logger
                        </h3>
                        ...
                        <tbody className="divide-y divide-gray-100">
                            {payouts.map((payout) => (
                                ...
                                >
                                    ...
                                    <td className="px-6 py-4">
                                        <span
                                            className={`px-2.5 py-1 rounded-md text-xs font-bold border ${payout.status === "Cleared" ? "bg-emerald-100 text-emerald-700 border-emerald-200" : "bg-orange-100 text-orange-700 border-orange-200"}`}
                                        >
                                            {payout.status}
                                        </span>
                                    </td>
