...
const majorWonders = [
    {
        ...
        reviews: "520",
        description:
            "Built by King Pandukabhaya in the 4th century BC, this is the oldest recorded man-made reservoir in Sri Lanka, a testament to early hydraulic engineering.",
    ...
    },
    {
        ...
        reviews: "610",
        description:
            "The largest of Anuradhapura's three main reservoirs, built to supply water to the ancient capital. Its massive bund reflects highly advanced ancient topographical knowledge.",
    ...
    },
    {
        ...
        reviews: "740",
        description:
            "Constructed by King Devanampiya Tissa in the 3rd century BC, this vast reservoir provided water to the Royal Gardens and remains vital to the region's agriculture today.",
...
const hiddenMarvels = [
    {
        ...
        reviews: "890",
        description:
            "An absolute masterpiece of ancient hydrology and architecture. These beautifully proportioned bathing pools for monks feature advanced underground water filtration systems.",
    ...
    },
    {
        ...
        reviews: "415",
        description:
            "A gigantic ancient artificial pool built for the monks of Abhayagiri. It is so large that it can hold six Olympic swimming pools worth of water, fed by an intricate canal system.",
    ...
    },
    {
        ...
        reviews: "1420",
        description:
            "A 4th-century masterpiece of Sinhalese sculpture depicting the Buddha in deep meditation. The dolomite marble statue is renowned for its profound expression of inner peace.",
    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-[#FAF9F6] text-[#2c1d11] font-sans selection:bg-royalGold-500 selection:text-royalMaroon-950 flex flex-col">
                ...
                >
                    <img
                        src="/images/ancient_hydraulic.png"
                        alt="Ancient Hydraulic & Architecture Wonders"
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
                        ...
                        <p className="mt-3 text-white/70 text-sm max-w-xl font-light">
                            Marvel at the extraordinary engineering genius of
                            Sri Lanka's ancient civilization, from vast
                            reservoirs to sky-kissing stupas.
                        </p>
                    </div>
                </motion.div>
                ...
                >
                    ...
                    <div className="space-y-3 text-left border-b border-royalGold-400/20 pb-8">
                        ...
                        <p className="text-slate-500 font-light text-sm max-w-lg">
                            Explore magnificent ancient reservoirs, towering
                            stupas, cave temples, and engineering marvels that
                            testify to the extraordinary genius of Sri Lanka's
