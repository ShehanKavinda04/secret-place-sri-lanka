...
import RolePermissionsCard from "../../Pages/Admin/Profile/Partials/RolePermissionsCard";
    ...
    if (!data) {
        return (
            <div className="w-full p-6 bg-[#EF4444]/10 rounded-2xl border border-[#EF4444]/20 flex items-center gap-4">
                ...
                <div>
                    <h3 className="font-bold text-[#EF4444] text-lg">
                        Security Subsystem Unavailable
                    </h3>
                    <p className="text-sm text-[#EF4444]/80">
                        Failed to establish a secure connection. Please refresh
                        the page.
                    </p>
                </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto space-y-8 pb-20">
            ...
            <div>
                ...
                <p className="text-slate-500">
                    Manage your privileges, active sessions, and system
                    notifications.
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
                <div className="xl:col-span-1">
                    <RolePermissionsCard
                        profile={{ role: data.role, permissions: [] }}
                    />
                </div>
